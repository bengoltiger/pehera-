    ...
    return {
        ...
        "accounts": [
            {"username": "citizen", "password": "citizen123", "role": "citizen",
             "description": "Citizen view for Sinhagad Road Ward"},
            {"username": "nagrik", "password": "citizen123", "role": "citizen",
             "description": "Hindi-language citizen for Katraj–Ambegaon Ward"},
            {"username": "authority", "password": "authority123", "role": "authority",
             "description": "District officer — command centre, alert approval"},
